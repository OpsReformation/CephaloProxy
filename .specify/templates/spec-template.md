...
you implement just ONE of them, you should still have a viable MVP (Minimum
...
**Independent Test**:
[Describe how this can be tested independently - e.g., "Can be fully tested by [specific action]
...
<!-- ACTION REQUIRED: The content in this section represents placeholders. Fill
them out with the right edge cases.
-------------------------------------------------------------------------------
...
<!-- ACTION REQUIRED: The content in this section represents placeholders. Fill
them out with the right functional requirements.
-------------------------------------------------------------------------------
...
- **FR-003**: Users MUST be able to
  [key interaction, e.g., "reset their password"]
...
- **SC-001**:
  [Measurable metric, e.g., "Users can complete account creation in under 2 minutes"]
- **SC-002**:
  [Measurable metric, e.g., "System handles 1000 concurrent users without degradation"]
- **SC-003**:
  [User satisfaction metric, e.g., "90% of users successfully complete primary task on first attempt"]
